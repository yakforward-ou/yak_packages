...
extension SpeedTestAsyncX<T> on Future<T> Function() {
  /// runs a speed test
  void speedTest({
    int laps = 10000,
    ...
    {
      final warmup = await sprintAsync(
        subject: this,
    ...
    final record = await raceAsync(subject: this, duration: duration);
    if (record == null) {
