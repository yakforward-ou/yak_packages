...
/// a typedef for an async  "multi-argument"  [Function]
typedef MultiArgFunctionFutureOr2<T, S, U>
    = MultiArgFunction2<FutureOr<T>, S, U>;

/// a typedef for an async  "multi-argument"  [Function]
typedef MultiArgFunctionFutureOr3<T, S, U, V>
    = MultiArgFunction3<FutureOr<T>, S, U, V>;

/// a typedef for an async  "multi-argument"  [Function]
typedef MultiArgFunctionFutureOr4<T, S, U, V, W>
    = MultiArgFunction4<FutureOr<T>, S, U, V, W>;

/// a typedef for an async  "multi-argument"  [Function]
typedef MultiArgFunctionFutureOr5<T, S, U, V, W, X>
